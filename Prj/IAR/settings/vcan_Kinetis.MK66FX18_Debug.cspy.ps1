...
{
& "E:\Program Files (x86)\IAR Systems\Embedded Workbench 7.2\common\bin\cspybat" -f "D:\Smart Car Program\Software\EDD smart car\V1.1\Prj\IAR\settings\vcan_Kinetis.MK66FX18_Debug.general.xcl" --debug_file=$debugfile --backend -f "D:\Smart Car Program\Software\EDD smart car\V1.1\Prj\IAR\settings\vcan_Kinetis.MK66FX18_Debug.driver.xcl" 
}
